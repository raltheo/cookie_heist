...
export default function Header() {
    ...
    const [headermob, setHeadermob ] = React.useState(false)
    ...
    <div>
      ...
      <div className='container_header'>
        <div className='header'>
            ...
            <h2 className="toggle_header" onClick={visible} >☰</h2>
            {headermob && <div className='nav_header_mobile'>
            <h2 className="cross_header" onClick={visible}>✖</h2>
                {!connecter &&<Link href='/'>
                    <p className={router.pathname == "/" ? "active_header" : "inactive_header"}>Accueil</p>
                </Link>}
                {!connecter && <Link href='/login'>
